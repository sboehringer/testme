...
packageDefinition = list(
	...
	description = list(
		...
		description = "Simplify unit and integrated testing by using implicit definitions. When writing new functions, users usually use example invocations for checking. Exactly this should be and is enough to develop tests using \\code{testme}. Use \\code{?'testme-package'} or visit the project wiki <https://https://github.com/sboehringer/testme/wiki> for a tutorial.",
