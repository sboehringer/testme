...
We do not see any path listed anymore as expectations now exist already. This is reflected by `Nvivified` which is zero. 


That's it. Running the tests will preserve the definition (meaning) of you function by storing the output of variables `Td`. Subsequent runs will check against these definitions. If your tests fail, you know that code relying on previous definitions might break.
